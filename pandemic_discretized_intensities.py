...
intensity_levels = gpd.ppf(percentiles)

# Calculate the CDF for each intensity level
cdf_values = gpd.cdf(intensity_levels)
...
# Calulate the intensity at a specific percentile
...
#csv_file_path = 'Percentiles Final2.csv'
